...
import {answersellerdispute} from "../../actions/admin";
...
const ViewProduct = () => { 
  ...
  const disputedata = JSON.parse(localStorage.getItem('adminsellerdispute'));
...
const handleSubmit=async(values,options)=>{
    ...
    if (result) {
      ...
      console.log(id);
         ...
         const data=await dispatch(answersellerdispute(values,id));
         if(data.message=="OK"){
            ...
            toast.success('Dispute Answered !', {
             ...
             window.location.href=`/DisputeSellers/admin/${authdata.email}` 
         }
         else{
...
<div className="middlediv">
    <div style={{
        ...
        <p style={{fontWeight:"600",color:'gray'}}>Seller Email <span style={{fontWeight:"800",color:'black'}}>: {disputeitem.selleremail}</span></p>
