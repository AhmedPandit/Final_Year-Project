...
const ViewSellers = () => {
 ...
 const authdata = JSON.parse(localStorage.getItem('adminprofile'));
  ...
  const getiddata = async () => {
    ...
    const data=await dispatch(getadminuser(tosend));
  ...
  const handleViewSeller=(id)=>{
    console.log(id)
    window.location.href=`/ViewSeller/admin/${user}/${id}`
                   ...
                   <form
                    ...
                    >
                      ...
                      <MDBCol size={12}>
                          ...
                          <MDBBtnGroup>
                            <button  className={` ${activeButton === 1 ? "active" : ""}`} onClick={()=>handleFilter(1)}>Active Sellers</button>
                            <button  className={` ${activeButton === 2 ? "active" : ""}`}   onClick={()=>handleFilter(2)}>Deactivated Sellers</button>
