...
const ViewProduct = () => { 
  ...
  const sellerdata = JSON.parse(localStorage.getItem('adminseller'));
...
<div className="middlediv">
    <div style={{
        ...
        <p style={{fontWeight:"700",color:'gray',fontSize:"20px"}}> Seller Summary </p>
        ...
        <p style={{fontWeight:"600",color:'gray'}}>Account Status <span style={{fontWeight:"800",color:'black'}}>: {selleritem.accountstanding}</span></p>
        </div>
