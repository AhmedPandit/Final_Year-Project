    ...
    <div className="nav-item absolute right-1 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      ...
      <div>
        {userProfileData.map((item, index) => (
          <div key={index} onClick={()=>{window.location.href=`/warehouse/${item.desc}/${email}`}} className="flex gap-5 border-b-1 border-color p-4 hover:bg-light-gray cursor-pointer  dark:hover:bg-[#42464D]">
            <button
              type="button"
