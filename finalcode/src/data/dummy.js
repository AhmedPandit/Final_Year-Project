...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock,AiOutlineFolderView } from 'react-icons/ai';
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart,FiSettings,FiBox } from 'react-icons/fi';
import { FaWarehouse,FaWpforms} from 'react-icons/fa';
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft,BsFillChatRightDotsFill,BsFillBox2Fill, BsInboxes,BsQuestionDiamond} from 'react-icons/bs';

import { GiNotebook} from 'react-icons/gi';
import { TbBuildingWarehouse} from 'react-icons/tb';
import { IoMdContacts } from 'react-icons/io';
import { RiContactsLine, RiStockLine } from 'react-icons/ri';
import { MdOutlineSupervisorAccount,MdOutlineInventory2,MdViewInAr,MdPayments} from 'react-icons/md';
...
export const links2 = [
...

  {
    ...
    links: [
      {
        link:'Orders/warehouse/',
        name: 'Orders',
        icon: <BsInboxes />,
      },
      {
        link:'ViewWarehouseProducts/warehouse/',
        name: 'View Products',
        icon: <MdViewInAr />,
      },
      {
        link:'ViewSellers/warehouse/',
        name: 'View Sellers',
        icon: <RiContactsLine />,
      },
      {
        link:'SellersRequest/warehouse/',
        name: 'SellersRequest',
        icon: <RiContactsLine />,
      },
      ...
      {
        link:'FileDisputeWarehouse/warehouse/',
        name: 'File Dispute',
        icon: <GiNotebook />,
      },
      {
        link:'ViewDisputesWarehouse/warehouse/',
        name: 'View Disputes',
        icon: <AiOutlineFolderView />,
      },

      {
        link:'RequestPaymentWarehouse/warehouse/',
        name: 'Payment',
        icon: <MdPayments />,
      },
...
export const links3 = [
...

  {
    ...
    links: [
      ...
      {
        link:'Warehouses/admin/',
        name: 'Warehouses',
        icon: <MdViewInAr />,
      },
      {
        link:'DisputeSellers/admin/',
        name: 'Sellers Disputes',
        icon: <RiContactsLine />,
      },
    
      {
        link:'DisputeWarehouse/admin/',
        name: 'Warehouse Disputes',
        icon: <FaWpforms />,
      },
    
      {
        link:'ViewBuyerQueries/admin/',
        name: 'Buyer Queries',
...
export const linksseller = [
...

  {
    ...
    links: [
      ...
      {
        link:'FileDispute/seller/',
        name: 'File Dispute',
        icon: <GiNotebook />,
      },
      {
        link:'ViewDisputes/seller/',
        name: 'View Disputes',
        icon: <AiOutlineFolderView />,
      },
...
export const ordersData = [
  {
    ...
    buyername:"Ahmed",
    buyershippingaddress:"Kashmir",
    buyerpurchasedata:"Today",
    productid:"6410e2937503c0af38aff7dd",
    productprice:"Number",
    productquantity:"Number",
    creator:"ahmedpandit24@gmail.com",
    shippingmethod:"ahmedpandit24@gmail.com",
    status:"pending",
