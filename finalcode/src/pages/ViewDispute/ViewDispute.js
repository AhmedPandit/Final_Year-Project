...
const ViewProduct = () => { 
  ...
  const disputedata = JSON.parse(localStorage.getItem('sellerdispute'));
...
<div className="middlediv">
    <div style={{
        ...
        <p style={{fontWeight:"600",color:'gray'}}>Warehouse Email <span style={{fontWeight:"800",color:'black'}}>: {disputeitem.disputeagainst}</span></p>
        </div>
