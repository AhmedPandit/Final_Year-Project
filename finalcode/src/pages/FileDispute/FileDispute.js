...
import { filedisputeseller } from "../../actions/user";
...
const FileDispute = () => {
    ...
    const handleSubmit=async(values,options)=>{
           ...
           const result = await confirm("Are you sure You want to File Dispute against this warehouse?", options);
           if (result) {
             console.log("You click yes!");
             
                const data=await dispatch(filedisputeseller(values));
                ...
                window.location.href=`/ViewDisputes/seller/${authdata.email}` 

                }
                else{

                    toast.error('No Warehouse with this email exists !', {
                        position: toast.POSITION.TOP_RIGHT
                    });
